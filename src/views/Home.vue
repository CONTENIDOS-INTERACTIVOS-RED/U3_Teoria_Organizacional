        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La estrategia organizacional, la estructura, el poder, la política, el control, la cultura y el cambio organizacional desempeñan un papel fundamental en la sostenibilidad y éxito de las organizaciones. En esta unidad, se estudiará cómo estos elementos interactúan para moldear la dirección de una empresa, influir en su desempeño y facilitar su capacidad de adaptación en un entorno competitivo. Se analizarán los distintos tipos de estructuras organizacionales y su alineación con la estrategia, los mecanismos de control y el papel de la cultura organizacional en la gestión del cambio. 
              
              p #[b ¡Prepárese para desarrollar una visión estratégica y comprender cómo las organizaciones diseñan su estructura, gestionan su cultura y enfrentan los retos del cambio en un mundo en constante evolución!]
